const crypto = require('crypto'),
    Swarm = require('discovery-swarm'), //creates network smarm to find & connect peers
    defaults = require('dat-swarm-defaults'), //deploys servers that are used to discover other peers
    getPort = require('get-port'),
    chain =  require("./chain"), //Chain class
    CronJob = require('cron').CronJob; //automates tasks
    express = require("express"),
    bodyParser = require('body-parser'),
    wallet = require('./wallet'); //wallet class
...
let initHttpServer = (port) => {
    ...
    //HTTP server so as to access the console output on browser as well.
};
